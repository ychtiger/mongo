...
// RUN-TEST: python buildscripts/smoke.py --auth jstests/core/readonly.js
...
jsTest.log('Test must be admin database')
...
jsTest.log('Test command format')
