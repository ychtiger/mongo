...
private:
    void _init(const std::string& ns, const StringData& coll);
...
public:
    ...
    */
    ...
    void setRemoteID(const OID& rid) {
        _remoteId = rid;
...
public:
    ...
    */
    ...
    public:
         ...
         * or just created.
         */
        Context(OperationContext* txn, const std::string& ns, Database* db, bool justCreated);
