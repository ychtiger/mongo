...
AuditEventAliCloudDBEncoder::~AuditEventAliCloudDBEncoder() {}
std::ostream& AuditEventAliCloudDBEncoder::encode(const AuditEventEphemeral& event,
                                                  std::ostream& os) {
    // tid
...
void AuditEventAliCloudDBEncoder::encode(const AuditEventEphemeral& event,
                                         std::stringstream& s) {
    // tid
    s << event.getThreadId();
    s << '\t';
