...
class RotatableFileAsyncAppender : public Appender<Event> {
    MONGO_DISALLOW_COPYING(RotatableFileAsyncAppender);
...
public:
     ...
     */
    RotatableFileAsyncAppender(EventEncoder* encoder, RotatableFileWriter* writer)
